...
/// active : 21518360
/// critical : 35264
/// casesPerOneMillion : 89547
/// deathsPerOneMillion : 890.4
/// tests : 7009035002
/// testsPerOneMillion : 882201.67
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2708.44
/// recoveredPerOneMillion : 84273.05
/// criticalPerOneMillion : 4.44
/// affectedCountries : 231

Worldstats worldstatsFromJson(String str) => Worldstats.fromJson(json.decode(str));
String worldstatsToJson(Worldstats data) => json.encode(data.toJson());
class Worldstats {
  Worldstats({
      num? updated, 
      num? cases, 
